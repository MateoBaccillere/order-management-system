...
public class OrderClient {
    ...
    public OrderResponse getOrderById(Long orderId) {
        ...
        try {
            ...
            throw new OrderServiceIntegrationException("Failed to retrieve order from order-service");
        }
    }
    ...
    public void markOrderAsShipped(Long orderId) {
        ...
        try {
            ...
            throw new OrderServiceIntegrationException("Failed to mark order as shipped in order-service");
        }
    }
}
